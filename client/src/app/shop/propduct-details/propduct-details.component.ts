...
export class PropductDetailsComponent implements OnInit {
  ...
  constructor(private shopService: ShopService, private activateRoot: ActivatedRoute, private bcService: BreadcrumbService, private basketService: BasketService) {
